...
export default function WelcomePage() {
  ...
  const yCity = useTransform(scrollY, [0, 100, 200, 300], [0, -50, -100, -150]);
  const opacityCity = useTransform(scrollY,[0, 200, 300, 500], [1, 0.7, 0.4, 0]);

  const yHero = useTransform(scrollY, [0, 100, 200, 300], [0, -100, -150, -200]);
  const opacityHero = useTransform(scrollY,[0, 200, 300, 500], [1, 0.7, 0.4, 0]);

  const yText = useTransform(scrollY, [0, 100, 200, 300, 500], [0, 50, 150, 200, 300]);
  const scaleText = useTransform(scrollY, [0, 100, 200, 300], [1, 1.1, 1.3, 1.4]);
